...
| **F** | U1 task set | | The three repository sample tasks (`task_42`, `task_163`, `task_201`) plus two dev tasks picked in U0.5 by a seeded rule that adds a frequency and horizon not already covered. Teo may raise this to 8 to 10 tasks. | No |
